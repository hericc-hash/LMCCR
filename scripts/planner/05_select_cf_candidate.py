...
def main():
    ...
    if selected:
        src=out/f'04_{selected}_candidate.pt';dst=out/'05_stage2_3B_selected_candidate.pt';shutil.copy2(src,dst);rep['selected_checkpoint_sha256']=sha256_file(dst);rep['selected_candidate_name']=selected;rep['selected_candidate']=audits[selected_name]
    dumpj(rep,out/'05_CF_SELECTION_DECISION.json');print(json.dumps(rep,indent=2))
